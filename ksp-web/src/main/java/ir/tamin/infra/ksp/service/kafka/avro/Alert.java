...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private ir.tamin.infra.ksp.service.kafka.avro.AlertStatus status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, ir.tamin.infra.ksp.service.kafka.avro.AlertStatus status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (ir.tamin.infra.ksp.service.kafka.avro.AlertStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public ir.tamin.infra.ksp.service.kafka.avro.AlertStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(ir.tamin.infra.ksp.service.kafka.avro.AlertStatus value) {
    this.status = value;
  }
   ...
   */
  public static ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder newBuilder() {
    return new ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder newBuilder(ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder other) {
    if (other == null) {
      return new ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder();
    } else {
      return new ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder(other);
    }
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder newBuilder(ir.tamin.infra.ksp.service.kafka.avro.Alert other) {
    if (other == null) {
      return new ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder();
    } else {
      return new ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ir.tamin.infra.ksp.service.kafka.avro.Alert other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder setStatus(ir.tamin.infra.ksp.service.kafka.avro.AlertStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.tamin.infra.ksp.service.kafka.avro.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (ir.tamin.infra.ksp.service.kafka.avro.AlertStatus) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = ir.tamin.infra.ksp.service.kafka.avro.AlertStatus.values()[in.readEnum()];
